...
import { ListingsToolbar, ListingsToolbarProps } from '../../../components/listings/ListingsToolbar';
...
const Template: Story<ListingsToolbarProps> = (args) => <ListingsToolbar {...args} />;
